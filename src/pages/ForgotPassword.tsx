        ...
        {!isSubmitted ? (
          <>
            ...
            <div className="mb-8">
              <h1 className="text-3xl md:text-4xl font-display font-bold mb-3">
                ...
                <span className="text-gradient-gold">senha?</span>
              </h1>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Enviamos um link de recuperação para <span className="text-foreground font-medium">{email}</span>. Verifique sua caixa de entrada.
            </p>
            <Button
              variant="outline"
              size="lg"
