...
import { Crown, ArrowLeft, TrendingUp, Users, DollarSign, BarChart2, ChevronDown, ChevronUp, Calendar, Filter } from "lucide-react";
...
const Entradas = () => {
  ...
  const filtradas = casaSelecionada === "Todas"
    ? mockEntradas
    : mockEntradas.filter(e => e.casa === casaSelecionada);
