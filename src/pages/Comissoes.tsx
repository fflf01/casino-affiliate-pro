...
import { DollarSign, TrendingUp, Wallet, Clock, CheckCircle, Zap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold mb-6">
            Estrutura de <span className="text-gradient-neon">Comissões</span>
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Quanto mais você indica, maior sua porcentagem. Comissões justas e pagamentos garantidos.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-display font-bold text-center mb-12">
            Níveis de <span className="text-gradient-gold">Comissão</span>
          </h2>
      ...
      <section className="py-16 px-4 bg-casino-surface/30">
        <div className="container mx-auto">
          <h2 className="text-3xl font-display font-bold text-center mb-12">
            Por que Nosso <span className="text-gradient-gold">Programa</span>?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-display font-bold text-center mb-12">
            Métodos de <span className="text-gradient-neon">Pagamento</span>
          </h2>
            ...
            <div className="bg-gradient-card rounded-2xl border border-border/50 overflow-hidden">
              ...
              {paymentMethods.map((method, index) => (
                ...
                >
                  ...
                  <span className="text-center text-muted-foreground">{method.time}</span>
                  <span className="text-right text-secondary font-semibold">{method.min}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="bg-gradient-card rounded-xl p-6 border border-border/50">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">
            Comece a <span className="text-gradient-neon">Ganhar Hoje</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
            Cadastre-se gratuitamente e comece a receber comissões ainda esta semana
          </p>
          <Link to="/cadastro">
